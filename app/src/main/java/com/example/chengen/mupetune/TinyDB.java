...
public class TinyDB {
   ...
   public ArrayList<SongsDatas> getListObject(String key, Class<?> mClass){
    	Gson gson = new Gson();
     	ArrayList<String> objStrings = getListString(key);
    	ArrayList<SongsDatas> objects =  new ArrayList<>();
    	for(String jObjString : objStrings){
    		SongsDatas value  = (SongsDatas) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
   ...
   public void putListObject(String key, ArrayList<SongsDatas> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(SongsDatas obj : objArray){
